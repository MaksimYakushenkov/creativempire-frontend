                ...
                <div className='switch__description'>
                  <div className='switch__description-item switch__description-item_active' data-description={1}>
                    <div className='description__container'>
                      <h2 className=''>В нашей команде — только профессионалы</h2>
                  ...
                  <div className='switch__description-item' data-description={2}>
                    <div className='description__container'>
                      <h2 className=''>Лучшим клиентам — лучший дизайн!</h2>
                  ...
                  <div className='description__container'>
                      <h2 className=''>Полный контроль и ведение</h2>
                      <p className='detail__paragraph'>
                      Разработка дизайна происходит в несколько этапов (обзор конкурентов, прототипование, создание дизайна, внесение правок) — ознакомиться со всеми можно здесь: <Link to='/work-plan'>план работы</Link>. После подтверждения заказа вы всегда будете знать о том, на каком этапе разработки находится ваш проект, в какие сроки этот этам будет реализован. Помимо этого, вы всегда сможете тщательно ознакомиться с проделанной работой. Мы готовы сделать некритичные правки без дополнительной оплаты.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='description__container'>
                      ...
                      <p className='detail__paragraph'>
                      Когда ваш сайт «под ключ» будет готов, мы предоставим вам полный доступ к хостингу и админ-панели (если это подразумевает проект).<br/><br/>Мы настроены на долгосрочное сотрудничество с нашим клиентом. Поэтому всегда готовы оказывать любую техническую поддержку сайта. Вы сможете решить любой вопрос , связанный с работой и редактированием компонентов действующего сайта.
                      </p>
                    </div>
                  </div>
